function [rowsum_x, rowsum_y, trace_x, trace_y, cov_prodsum] = prepare_stats_with_blocks_loaded_distance(distance_matfile, distance_variable, bx, by, distance_blocks)
%[rowsum_x, rowsum_y, trace_x, trace_y, cov_prodsum] = prepare_stats_with_blocks_loaded_distance(distance_matfile, distance_variable, bx, by, distance_blocks)
%Prepare stats from each block's loaded distance matrix and covariance model, for
