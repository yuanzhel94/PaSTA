function [rowsum_x, rowsum_y, trace_x, trace_y, cov_prodsum] = prepare_nonstationary_stats_with_blocks_loaded_distance(distance_matfile, distance_variable, parc_idx_x, bs_x, parc_idx_y, bs_y, dim, distance_blocks)
%[rowsum_x, rowsum_y, trace_x, trace_y, cov_prodsum] = prepare_nonstationary_stats_with_blocks_loaded_distance(distance_matfile, distance_variable, parc_idx_x, bs_x, parc_idx_y, bs_y, dim, distance_blocks)
%Prepare stats from each block's loaded distance matrix and nonstationary covariance model, for
