function [fc_para, bs] = parcellated_cov(x, parc, unique_parcs, D, dim, b, fc_para, qd, M_scale, nugget, crossblock, kernel_scale)
...
for i=1:n_parc
    ...
    MM = ceil(sqrt(length(x_select))) * M_scale;
    [va_select,h1_select] = estimate_variogram(D_select, x_select, MM, qd, kernel_scale);
